...
class TaskModel(models.Model):
    ...
    reviewer = models.ForeignKey(UserModel, on_delete=models.CASCADE,related_name='reviewer_id')
    assignee = models.ForeignKey(UserModel, on_delete=models.CASCADE,related_name='assignee_id')
